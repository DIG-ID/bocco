<section id="rmcontent-2" class="section section-rmcontent-2">
	<div class="container-fluid">
		<div class="row">
			<div class="col-12 col-md-12 col-lg-12 col-xl-6 section-rmcontent-2__leftcol">
			...
			<div class="col-12 col-md-12 col-lg-12 col-xl-6 section-rmcontent-2__rightcol">
                <div class="section-rmcontent-2__img-pack">
                    <img class="section-rmcontent-2__img-abtop" src="<?php echo wp_upload_dir()['url'] . '/RM_F_2.png' ?>">
                    <img class="section-rmcontent-2__img-abbot" src="<?php echo wp_upload_dir()['url'] . '/RM_F_1.png' ?>">
                </div>
			</div>
		</div>
	</div>
