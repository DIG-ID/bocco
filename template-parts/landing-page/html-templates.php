				...
				<div class="container">
					<div class="row align-items-center justify-content-center">
						<div class="col-12 col-sm-12 col-md-10 col-lg-7 text-center ">
							...
							<a href="<?php the_sub_field( 'button_url' ); ?>" data-fancybox data-type="iframe" class="iframe-mockup-link">
								<?php echo wp_get_attachment_image( $image, 'full' ); ?>
							</a>
							<a href="<?php the_sub_field( 'button_url' ); ?>" data-fancybox data-type="iframe" class="btn">
