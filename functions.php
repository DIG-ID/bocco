 ...
 * Setup theme
 */
function bocco_theme_setup() {

	register_nav_menus(
		array(
			'primary' => __( 'Primary Menu', 'bocco' ),
		)
	);
...
add_action( 'after_setup_theme', 'bocco_theme_setup' );

/**
 * Enqueue styles and scripts
 */
function bocco_theme_enqueue_styles() {
...
add_action( 'wp_enqueue_scripts', 'bocco_theme_enqueue_styles' );
