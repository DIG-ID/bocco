				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-12 col-lg-6">
							<p class="section__subtitle"><?php the_field( 'about_us_content_subtitle' ); ?></p>
							<h2 class="section__title"><?php the_field( 'about_us_content_title' ); ?></h2>
							<p class="section__description"><?php the_field( 'about_us_content_description' ); ?></p>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="container">
						<div class="row justify-content-center align-item-center">
							<div class="col text-center">
								<p class="section__subtitle"><?php the_field( 'team_subtitle' ); ?></p>
